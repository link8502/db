...
<style>
	body {
		background-image: url("./assets/qwe.jpg");
	...
	.sign-up-container {
		background-image: linear-gradient(to right, skyblue, grey);
	}
				...
				<form name="sign-up" action="" method="post" onsubmit="return signupValidation()">
					...
					<div class="row">
						<div class="inline-block">
							...
							<input class="input-box-330" type="text" name="fullname" id="fullname">
						</div>
					</div>
					<div class="row">
						<div class="inline-block">
					...
					<div class="row">
						<div class="inline-block">
							<div class="form-label">
								Birthday<span class="required error" id="bday-info"></span>
							</div>
							<input class="input-box-330" type="date" placeholder="Birthday (MM/DD/YY)" name="signup_birthday">
						</div>
					</div>
					<div class="row">
						<div class="inline-block">
